    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 hover:bg-transparent rounded"
        ),
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-5 w-5 bg-primary rounded" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-5 w-5 bg-primary rounded" />,
      }}
      {...props}
    />
  )
